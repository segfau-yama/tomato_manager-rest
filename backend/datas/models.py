...
class Tomato(models.Model):
    crop = models.ForeignKey(Crop, to_field='id', on_delete=models.CASCADE, null=False)
...
class Judgement(models.Model):
    forecast = models.ForeignKey(Crop, to_field='id', on_delete=models.CASCADE, null=False)
